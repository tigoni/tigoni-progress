...
export const Hero = () => {
  return (
    <section className="w-screen h-screen flex justify-center items-center bg-background-1">
      <div className="w-full md:max-w-3xl gap-y-8 lg:max-w-5xl flex text-center flex-col justify-center items-center">
        ...
        >
          <div className="size-16 lg:size-20 rounded-full bg-white"></div>
        ...
        <motion.div
          ...
          className="gap-y-4 my-[1vh] flex justify-center items-center flex-col"
        >
        ...
        >
          <div className="flex flex-col gap-4 sm:flex-row justify-center">
            <button
              className="bg-primary text-text-primary font-bold py-2 px-4 rounded-md w-40 lg:w-52 h-10 lg:h-12 hover:bg-primary/80 cursor-pointer transition"
            ...
            <button
              className="bg-background-2 border border-primary/50 text-text-primary font-bold py-2 px-4 rounded-md w-40 lg:w-52 h-10 lg:h-12 cursor-pointer hover:border-primary/90 transition"
              onClick={() => console.info("Hello")}
              aria-label="Get started"
            >
              Get my Resume
